...
What is **Block Scope**?
* Variable declared inside b/w curly braces will only be access within block & not access by the outside of the block.
    ...
    * Reason?
        ...
        * Thus we say, *let* and *const* are BLOCK SCOPED. Because,  They are stored in a separate mem space which is reserved for this block. Also, they can't be accessed outside this block.
